...
enum class PrismaIndexAlgorithm(val documentation: String) {
    ...
    Brin("Block Range Index. If the data has some natural correlation with their physical location within the table, can compress very large amount of data into a small space."),
}